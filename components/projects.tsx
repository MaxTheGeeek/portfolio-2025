  ...
  const projects = [
    {
      title: "Stereum Plus",
      description:
        "Advanced node management platform with enhanced features for professional users. Built with modern web technologies focusing on user experience and performance.",
      url: "https://www.stereumplus.com",
      type: "Web Application",
      icon: Globe,
      technologies: ["React.js", "Next.js", "TypeScript", "Node.js", "Mantine"],
      category: "Professional Platform",
    },
    {
      title: "Stereum",
      description:
        "Core node management application providing seamless setup and monitoring. Features intuitive interface and robust backend infrastructure.",
    ...
    },
    {
      title: "Rocklogic",
      description:
        "Corporate website for Rocklogic GmbH showcasing company services, portfolio, and expertise in software development solutions.",
    ...
    },
    {
      ...
      description:
        "Desktop application for managing nodes with intuitive GUI. Provides seamless installation, configuration, and monitoring through a native desktop experience.",
      url: null,
        ...
        <ScrollAnimation animation="fadeIn">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-300 text-lg max-w-2xl mx-auto">
              A showcase of websites and applications I've developed, ranging
              from management platforms to corporate websites and desktop
              applications.
            </p>
          </div>
        </ScrollAnimation>
          ...
          {projects.map((project, index) => (
            ...
            >
              <CardHeader className="flex-shrink-0">
                ...
                <Badge
                  variant="secondary"
                  className="bg-blue-500/20 text-blue-400 w-fit"
                >
                  {project.category}
                </Badge>
              </CardHeader>
          ...
          <div className="mt-16 text-center">
            <div className="bg-gray-800/30 rounded-lg p-8">
              ...
              <p className="text-gray-300 mb-6">
                These are just a few highlights of my work. I have experience
                with various other projects including e-commerce platforms,
              ...
              <div className="flex justify-center space-x-4">
                <Button
                  ...
                  onClick={() =>
                    window.open("https://maxbehzadi.online", "_blank")
                  }
                >
