...
export function Experience() {
  const experiences = [
    ...
    },
    {
      ...
      description: [
        "Engineered responsive vendor management dashboards",
        "Optimized component architecture for e-commerce",
        "Implemented data-heavy interfaces for product catalogs",
      ],
    ...
    },
    {
      ...
      description: [
        "Built MVP for diet-focused food delivery platform",
        "Implemented pixel-perfect, mobile-first responsive designs",
        "Collaborated with backend team on ordering interface",
      ],
    ...
    },
    {
      ...
      period: "2011 – 2013",
      description: [
        "Developed internal financial software using C# and .NET",
        "Built and maintained web portals using PHP",
        "Assisted in building accounting and reporting modules",
      ],
      technologies: ["C#", ".NET", "PHP", "SQL"],
      contact: "Tehran, Iran",
    },
    {
      title: "FinTech Consultant & Developer",
      company: "Sanat Shams",
      location: "Tehran, Iran",
      period: "2005 – 2010",
      description: [
        "Developed comprehensive finance and accounting platform",
        "Supported analysis, design, and implementation of financial modules",
        "Participated in the full software development lifecycle",
      ],
      technologies: ["C#", "Accounting", "Database Design"],
      contact: "Tehran, Iran",
    },
  ];
